...
if(empty($_POST['name']) || empty($_POST['phone']) || empty($_POST['company']) || empty($_POST['email']) || empty($_POST['message'])) {
...
$subject = 'This person has contact you via your contact form from MagBalloon '.$name;
$subject .= 'His phone number is '.$phone;
$message = 'Message is ';
